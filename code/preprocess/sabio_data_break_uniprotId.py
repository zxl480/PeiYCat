...
if __name__ == "__main__":
    input_file = "../../data/preprocess/sabio_filter_Kcat_unify_unit.json"
    cache_file = "../../data/preprocess/uniprot_entry_cache.json"
    output_file = "../../data/preprocess/sabio_data_only_one_uniprotId.json"
    ...
    for key, entry in data.items():
        if key == '36956':
            print(111)
        # uniprot_ids = list(set(entry["UniprotID"].split()))
        ...
        for uid in uniprot_ids:
            ...
            if entry_info is None:
                continue
            # name_info = entry_info.get("proteinDescription", {}).get("recommendedName", {}).get("fullName", {})
